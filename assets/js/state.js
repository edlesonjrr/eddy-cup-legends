...
export const makePlayer = id => {
  const player={id,formation:null,lineup:Array(11).fill(null),rerolls:MAX_REROLLS,currentRound:0,currentOptions:null,selectedPlayerIds:new Set(),offeredPlayerIds:new Set(),recentlyOfferedPlayerIds:[],coach:'',finishedDraft:false};
