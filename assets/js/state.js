...
export const game = {mode:'solo',active:'player1',locked:false,sound:true,matchFormat:'single',series:{home:0,away:0,game:1},players:{player1:makePlayer('player1'),player2:makePlayer('player2')},opponent:null};
export const activePlayer = () => game.players[game.active];
export function resetGame(mode='solo'){game.mode=mode;game.active='player1';game.locked=false;game.matchFormat='single';game.series={home:0,away:0,game:1};game.opponent=null;game.players.player1=makePlayer('player1');game.players.player2=makePlayer('player2')}
